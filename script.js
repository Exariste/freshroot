...
const DATA = {
  oil: {
    "sub-oil": {label:"Oil & Spices", items:["সরিষার তেল","সয়াবিন তেল","সূর্যমুখী তেল","অলিভ অয়েল","হলুদের গুঁড়া","মরিচের গুঁড়া","ধনিয়ার গুঁড়া","জিরার গুঁড়া","গোলমরিচের গুঁড়া","পাঁচফোড়ন","দারুচিনি","এলাচ","লবঙ্গ","আস্ত জিরা","তেজপাতা","আদা"]}
  },
  home: {
  ...
  grocery: {
    "sub-grocery": {label:"Food & Grocery", items:["চাল","আটা","মসুর ডাল","ছোলা","চিনি","লবণ","চা","কফি","মধু","বিস্কুট","ওটস","কর্নফ্লেক্স","টমেটো কেচাপ","পিনাট বাটার","কাঠবাদাম"]}
  }
};
