...
const DATA = {
  grocery: {
    ...
    "sub-oils": {label:"Oils & Ghee", items:["সয়াবিন তেল","সরিষার তেল","খাঁটি ঘি","অলিভ অয়েল"]},
    "sub-spices": {label:"Spices", items:["হলুদ","মরিচ","ধনিয়া","জিরা","গরম মশলা","এলাচ","দারুচিনি","লবঙ্গ","তেজপাতা","গোলমরিচের গুঁড়া","পাঁচফোড়ন","আস্ত জিরা","আদা"]},
    "sub-essentials": {label:"Essentials", items:["লবণ","চিনি","আটা","ময়দা","চাল","মধু","চা","কফি","বিস্কুট","ওটস","কর্নফ্লেক্স","টমেটো কেচাপ","পিনাট বাটার (চিনাবাদামের মাখন)","কাঠবাদাম"]}
  },
  household: {
    "sub-householdcare": {label:"Household Care", items:["ডিটারজেন্ট পাউডার","ডিটারজেন্ট লিকুইড","ফ্লোর ক্লিনার","টয়লেট ক্লিনার","গ্লাস ক্লিনার","টিস্যু","ঘর মোছার সাবান","ক্লিনিং টুলস","থালা-বাসন ধোয়ার তরল","ফ্যাব্রিক সফটনার","মাল্টি-পারপাস ক্লিনার","এয়ার ফ্রেশনার","জীবাণুনাশক তরল","বাথরুম ক্লিনার","কাপড় ধোয়ার বার সাবান","ব্লিচিং লিকুইড","দাগ অপসারণকারী"]},
    ...
    "sub-personalcare": {label:"Personal Care", items:["চুলের তেল","শ্যাম্পু","কন্ডিশনার","ফেসওয়াশ","সাবান","টুথপেস্ট","টুথব্রাশ","শেভিং কিট","প্রসাধনী","বডি ওয়াশ","শাওয়ার জেল","বডি লোশন","ফেস ক্রিম","সানস্ক্রিন","ডিওডোরেন্ট","হ্যান্ডওয়াশ","লিপ বাম","স্যানিটারি প্যাড","নেইল কাটার"]},
    "sub-beautycare": {label:"Beauty Care", items:["ফাউন্ডেশন","কমপ্যাক্ট পাউডার","কনসিলার","লিপস্টিক","আইলাইনার","মাসকারা","আইশ্যাডো প্যালেট","কাজল","ব্লাশ","হাইলাইটার","মেকআপ সেটিং স্প্রে","মেকআপ রিমুভার","লিপ গ্লস","মেকআপ টুলস","নেইল পলিশ ও রিমুভার"]},
    "sub-babycare": {label:"Baby Care", items:["ডায়াপার","সেরেলাক","বেবি ফুড","বেবি লোশন","বেবি পাউডার","বেবি অয়েল","বেবি সাবান","বেবি ওয়েট ওয়াইপস","বেবি শ্যাম্পু","বেবি বডি ওয়াশ","বেবি ক্রিম","বেবি ফিডিং বোতল","বেবি বোতল পরিষ্কারক","বেবি সিরিয়াল","বেবি টুথপেস্ট","বেবির কাপড় ধোয়ার ডিটারজেন্ট"]}
  },
  agro: {
